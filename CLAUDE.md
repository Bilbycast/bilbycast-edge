...
See the root `CLAUDE.md` feature flag table for the canonical list, defaults, and build prerequisites. Default build is LGPL-clean; `video-encoder-x264` / `-x265` / `-nvenc` are opt-in (GPL or vendor-specific). Full transcoder reference: [`docs/transcoding.md`](docs/transcoding.md).
