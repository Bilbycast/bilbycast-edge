...
//! SMPTE ST 2110-30 (linear PCM audio) input task.
//!
//! Thin wrapper around [`crate::engine::st2110_io::run_st2110_audio_input`]
//! with `is_aes3 = false`. Spawning conventions match
//! [`crate::engine::input_rtp::spawn_rtp_input`].
...
pub fn spawn_st2110_30_input(
    ...
    tokio::spawn(async move {
        ...
        .await
        {
            tracing::error!("ST 2110-30 input task exited with error: {e}");
        }
    })
}
